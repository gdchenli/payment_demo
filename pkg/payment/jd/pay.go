...
func (jd *Jd) CreatePayUrl(paramMap map[string]string, order common.OrderArg) (form string, errCode int, err error) {
...
func (jd *Jd) CreatePayForm(paramMap map[string]string, order common.OrderArg) (form string, errCode int, err error) {
